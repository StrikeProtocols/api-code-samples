...
def test_webhooks(client: Client):
    ...
    client.set_webhook_configuration('https://url1.com', 3, 1, 'test1@test.com')
    client.set_webhook_configuration('https://url2.com', 3, 1, 'test2@test.com')
    ...
    assert client.get_webhook_configuration()['url'] == 'https://url2.com'
    client.delete_webhook_configuration()
    client.get_webhook_configuration(expected_status_code=404)
